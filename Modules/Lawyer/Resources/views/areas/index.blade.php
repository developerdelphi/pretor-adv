...
<div class="container doubling stackable ui raised segment">
    <div class="ui items divided">
        <div class="item">
            <div class="icon">
                <i class="align left icon purple icon-header-size"></i>
            </div>
            <div class="middle align content">
                <h2 class="ui purple header">Gerenciamento de Áreas jurídicas
            ...
            <div class="right floated">
                <div class="ui vertical animated button primary" tabindex="0">
                    <a class="hidden content " href="{{ route('areas.create') }}">Novo</a>
        ...
        <div class="item">
            <table class="ui table compact celled striped selectable purple">
                        ...
                        <td class="right aligned">
                            <form action="{{ route('areas.destroy', ['area'=> $area->id]) }}" method="post">
                                ...
                                <div class="ui mini buttons icon" style="padding:0; margin:0;">
                                    <a href="{{ route('areas.show', ['area'=> $area->id]) }}"
